...
function setupPaymentButtons() {
    ...
    document.getElementById('pay-with-dana').addEventListener('click', function() {
        const account = document.querySelector('[data-number="083866671529"]').getAttribute('data-number');
    ...
    document.getElementById('pay-with-gopay').addEventListener('click', function() {
        alert(`Maaf, owner belum memiliki payment jenis GoPay, mohon pilih metode pembayaran lain!`);
    });
    ...
    document.getElementById('confirm-qris').addEventListener('click', function() {
        alert('Permintaan pembayaran dikirim ke owner 083866671529. Silakan periksa aplikasi Anda untuk menyelesaikan pembayaran.');
